...
def signup(request):
    if request.method == "POST":
        ...
        if sum(c.isdigit() for c in pass1) < 1:
        ...
        # Welcome Email
        subject = "Welcome to team Farmcut login!!"
        message = "Hello " + myuser.first_name + "!! \n" + "Welcome to onlibe catering system Farmcut !! \nThank you for visiting our website\n. We have also sent you a confirmation email, please confirm your email address. \n\nThanking You\Farmcut"        
        ...
        email_subject = "Confirm your Email @ Farmcut Login!!"
...
def signin(request):
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            return render(request, "catering.html",{"username":username})
        else:
